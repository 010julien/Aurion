...
// Toujours en mode front-only, sans dépendre des variables d'environnement
const FRONT_ONLY = true;
const FRONT_EMAIL = "admin@aurion.tg";
const FRONT_PASSWORD = "admin123";
const DEMO = false;
